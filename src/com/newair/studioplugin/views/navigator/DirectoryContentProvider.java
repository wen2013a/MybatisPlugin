...
/**
 * contentProvider,就是遍历IProject或IFolder的子资源(Folder或File)
 */
public class DirectoryContentProvider extends WorkbenchContentProvider {
	...
	private void processDelta(IResourceDelta delta, Collection runnables) {
		...
		if ((changeFlags & (IResourceDelta.OPEN | IResourceDelta.SYNC | IResourceDelta.TYPE | IResourceDelta.DESCRIPTION)) != 0) {
			...
			/*
			 * support the Closed Projects filter; when a project is closed, it
			 * may need to be removed from the view.
			 */
